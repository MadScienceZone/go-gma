...
func TestDiceStructured(t *testing.T) {
	...
	testcases := []testcase{
		...
		{Roll: "d20+27|c19|c18", Reslist: []StructuredResult{
			{Result: 32, Details: []StructuredDescription{
				{Type: "result", Value: "32"},
				{Type: "separator", Value: "="},
				{Type: "diespec", Value: "1d20"},
		...
		// 91: multi-min-max
		{Roll: "d20+27|max15|max16|min10|min11|min12", Reslist: []StructuredResult{
			{Result: 32, Details: []StructuredDescription{
				{Type: "result", Value: "32"},
				{Type: "separator", Value: "="},
				{Type: "diespec", Value: "1d20"},
		...
		// 93: multi-until
		{Roll: "d20+27|until30|until42", Reslist: []StructuredResult{
			{Result: 32, Details: []StructuredDescription{
				{Type: "result", Value: "32"},
				{Type: "separator", Value: "="},
				{Type: "diespec", Value: "1d20"},
		...
		// 95: multi-repeat
		{Roll: "d20+27|repeat3|repeat5", Reslist: []StructuredResult{
			{Result: 32, Details: []StructuredDescription{
				{Type: "result", Value: "32"},
				{Type: "separator", Value: "="},
				{Type: "diespec", Value: "1d20"},
