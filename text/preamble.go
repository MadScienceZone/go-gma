...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  _______  _______  _______              ______      __     ______         _______  _ %
% (  ____ \(       )(  ___  )            / ____ \    /  \   / ____ \       (  ___  )(  %
% | (    \/| () () || (   ) |           ( (    \/    \/) ) ( (    \/       | (   ) ||  %
% | |      | || || || (___) |           | (____        | | | (____   _____ | (___) ||  %
% | | ____ | |(_)| ||  ___  |           |  ___ \       | | |  ___ \ (_____)|  ___  ||  %
% | | \_  )| |   | || (   ) | Game      | (   ) )      | | | (   ) )       | (   ) ||  %
% | (___) || )   ( || )   ( | Master's  ( (___) ) _  __) (_( (___) )       | )   ( ||  %
% (_______)|/     \||/     \| Assistant  \_____/ (_) \____/ \_____/        |/     \|(_ %
%                                                                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% @[00]@| GMA Core 6.16-alpha
% @[01]@|
